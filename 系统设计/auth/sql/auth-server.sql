/*
 ...
 Source Schema         : auth-server

 Target Server Type    : MySQL
 Target Server Version : 80011
 File Encoding         : 65001

 Date: 11/03/2025 01:54:10
*/
...
-- ----------------------------
INSERT INTO `oauth2_authorization_consent` VALUES ('client-id', 'account', 'SCOPE_offline_access');
...
CREATE TABLE `t_account`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '账号表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of t_account
-- ----------------------------
INSERT INTO `t_account` VALUES (2, 'account', '{bcrypt}$2a$10$PABaNrQ9TMJMyKiQMQEEHO/4TwZgF4Iv3TgJGY.Xly5k5hlgMwZlS', 0, 0, 0, 0, '2025-02-26 23:56:35', '2025-02-26 23:56:35', 0, 0);

-- ----------------------------
-- Table structure for t_account_roles
-- ----------------------------
...
CREATE TABLE `t_account_roles`  (
  ...
  `is_deleted` tinyint NOT NULL DEFAULT 0 COMMENT '逻辑删除 0 未删除 1 已删除',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `account_id`(`account_id` ASC, `role_id` ASC, `tenant_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '账号角色关联表 该表可实现账号角色租户多对多关联' ROW_FORMAT = Compact;
...
-- ----------------------------
-- Table structure for t_account_tenants
-- ----------------------------
...
CREATE TABLE `t_account_tenants`  (
  ...
  `account_id` bigint NOT NULL COMMENT '账号ID',
  `tenant_id` bigint NOT NULL COMMENT '租户ID',
  `is_primary` tinyint(1) NULL DEFAULT 0 COMMENT '是否主租户',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '更新时间',
  `version` int NOT NULL DEFAULT 0 COMMENT '版本号',
  `is_deleted` tinyint NOT NULL DEFAULT 0 COMMENT '逻辑删除 0 未删除 1 已删除',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `account_id`(`account_id` ASC, `tenant_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '账号租户关联表 该表可实现账号租户多对多关联' ROW_FORMAT = Compact;
...
CREATE TABLE `t_binding`  (
  ...
  `is_deleted` tinyint NOT NULL DEFAULT 0 COMMENT '逻辑删除 0 未删除 1 已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '账号绑定表' ROW_FORMAT = Compact;
...
CREATE TABLE `t_member`  (
  ...
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '会员描述',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '更新时间',
  `version` int NOT NULL DEFAULT 0 COMMENT '版本号',
  `is_deleted` tinyint NOT NULL DEFAULT 0 COMMENT '逻辑删除 0 未删除 1 已删除',
...
-- ----------------------------
-- Table structure for t_member_buy_record
-- ----------------------------
...
CREATE TABLE `t_member_buy_record`  (
  ...
  `is_deleted` tinyint NOT NULL DEFAULT 0 COMMENT '逻辑删除 0 未删除 1 已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '会员购买记录表' ROW_FORMAT = Compact;
...
-- ----------------------------
-- Table structure for t_member_permissions
-- ----------------------------
...
CREATE TABLE `t_member_permissions`  (
  ...
  `is_deleted` tinyint NOT NULL DEFAULT 0 COMMENT '逻辑删除 0 未删除 1 已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '会员权限表' ROW_FORMAT = Compact;
...
CREATE TABLE `t_permissions`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `tenant_id` bigint NOT NULL COMMENT '租户ID',
  `permission_type` enum('FIELD','URL','ROUTE') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '权限类型 FIELD 字段 URL URL ROUTE 路由',
  `permission_value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '权限值',
  ...
  `is_deleted` tinyint NOT NULL DEFAULT 0 COMMENT '逻辑删除 0 未删除 1 已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '权限表' ROW_FORMAT = Compact;
...
CREATE TABLE `t_profile`  (
  ...
  `location` int NULL DEFAULT NULL COMMENT '地址编码',
  ...
  `is_deleted` tinyint NOT NULL DEFAULT 0 COMMENT '逻辑删除 0 未删除 1 已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '个人资料表' ROW_FORMAT = Compact;
...
-- ----------------------------
-- Table structure for t_tenants
-- ----------------------------
DROP TABLE IF EXISTS `t_tenants`;
CREATE TABLE `t_tenants`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `parent_id` bigint NOT NULL COMMENT '父租户ID',
  `tenant_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '租户编码',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '租户表' ROW_FORMAT = Compact;
